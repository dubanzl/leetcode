/*
    ...
    “Total speed” is defined as the sum of the speeds of all the tandem bicycles being ridden. For example, if there are 4 riders (2 red-shirt riders and 2 blue-shirt riders) who have speeds of [1, 3, 4, 5], and they're paired on tandem bicycles as follows: [1, 4], [5, 3], then the total speed of these tandem bicycles is 4 + 5 = 9.
...
function tandemBicycle(redShirtSpeeds, blueShirtSpeeds, fastest) {
  if (fastest) {
    return calculateFastestSpeed(redShirtSpeeds, blueShirtSpeeds);
  } else {
    return calculateMinimumSpeed(redShirtSpeeds, blueShirtSpeeds);
  }
}

function calculateFastestSpeed(redShirtSpeeds, blueShirtSpeeds) {
  let maxSpeed = 0;
...
function calculateMinimumSpeed(redShirtSpeeds, blueShirtSpeeds) {
  let minSpeed = 0;
...
function tandemBicycle(redShirtSpeeds, blueShirtSpeeds, fastest) {
  ...
  // Reverse one array if we need the fastest total speed
